...
import cv2
from lib_darnn.fcn.config import cfg
from lib_darnn.utils.blob import im_list_to_blob, pad_im, chromatic_transform
from lib_darnn.utils.se3 import *
import scipy.io
#from lib_darnn.normals import gpu_normals
...
def _get_image_blob(roidb, scale_ind):
    ...
    return blob, blob_depth, None, im_scales
